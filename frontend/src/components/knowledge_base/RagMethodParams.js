 ...
 */
const RagMethodParams = ({
  methodId,
  onChange,
  showSearchParams = true,
  showIndexParams = true,
}) => {
        ...
        return (
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            >
              ...
              />
              {paramConfig.unit && (
                <Text type="secondary">{paramConfig.unit}</Text>
              )}
            </div>
          </div>
        );
  ...
  return (
    ...
    >
        ...
        Object.keys(methodDetails.indexParams || {}).length > 0 && (
          <div className="param-section" style={{ marginBottom: 16 }}>
            ...
            <Form layout="vertical">
              {Object.entries(methodDetails.indexParams || {}).map(
      ...
      {showSearchParams &&
        Object.keys(methodDetails.searchParams || {}).length > 0 && (
          <div className="param-section">
            ...
            <Form layout="vertical">
              {Object.entries(methodDetails.searchParams || {}).map(
                ([paramName, paramValue]) => {
                  const example = getParamExample(paramName);
                  return (
                    <Form.Item
