...
const TAG_COLORS = ['blue', 'cyan', 'geekblue', 'purple', 'magenta', 'green', 'lime', 'orange'];
    ...
    if (!keywordList || keywordList.length === 0 || !Array.isArray(keywordList)) {
      ...
      return (
        <div style={{ 
          ...
          <HighlightOutlined style={{ fontSize: '48px', color: '#bfbfbf', marginBottom: '16px' }} />
          <div><Text type="secondary">暂无关键词</Text></div>
        </div>
      );
    }
          ...
          <div style={{ marginTop: 20 }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
              {normalKeywords.map((keyword, index) => (
                <Tag 
                  color={TAG_COLORS[(index + importantKeywords.length) % TAG_COLORS.length]} 
  ...
  return (
    <div>
      <div style={{ 
        ...
        <Title level={2} style={{ color: 'white', margin: 0 }}>关键词提取</Title>
