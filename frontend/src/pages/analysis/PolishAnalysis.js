  ...
  const polishDocument = async () => {
    ...
    try {
      ...
      if (inputType === "text") {
        ...
        // 使用文档ID润色
        response = await documentAPI.polishDocumentFromDocument(
          selectedDocument.id,
          polishType
        );
      }
  ...
  const polishTypes = [
    {
      value: "formal",
      label: "正式",
      description: "适合商务报告、论文等正式场合",
      icon: <FileTextOutlined />,
    },
    {
      value: "simple",
      label: "简洁",
      description: "直接明了，易于理解",
      icon: <ReadOutlined />,
    },
    {
      value: "creative",
      label: "创意",
      description: "生动有趣，适合营销文案",
      icon: <EditOutlined />,
    },
  ];
                  ...
                  <Tooltip key={type.value} title={type.description}>
                    <Card
                      ...
                      style={{
                        width: 120,
                        borderColor:
                          polishType === type.value ? "#52c41a" : undefined,
                        backgroundColor:
                          polishType === type.value ? "#f6ffed" : undefined,
                      }}
                    ...
                    >
                      ...
                      >
                        <Avatar
                          ...
                          style={{
                            backgroundColor:
                              polishType === type.value ? "#52c41a" : "#f0f0f0",
                            marginBottom: 8,
                          }}
                        />
                        <div
                          style={{
                            fontWeight:
                              polishType === type.value ? "bold" : "normal",
                            color:
                              polishType === type.value ? "#52c41a" : undefined,
                          }}
                        >
            ...
            >
              ...
              {(analyzeCount > 0 || polishedContent) && (
                <Badge count={analyzeCount} offset={[0, 4]}>
                  <Text type="secondary">已润色 {analyzeCount} 次</Text>
                </Badge>
              )}
            </div>
          </Card>
                    ...
                    children: (
                      <div style={{ display: "flex", gap: "16px" }}>
                        ...
                        >
                          <MarkdownRenderer
                            content={
                              inputType === "text" ? content : documentContent
                            }
                          />
                        </Card>
                        <Card
          ...
          >
            <div style={{ padding: "0 8px" }}>
              ...
              <div>
                ...
                <ul style={{ paddingLeft: "20px", marginTop: "8px" }}>
                  <li>
                    <Text strong>正式：</Text>适合商务报告、论文等正式场合
                  </li>
                  <li>
                    <Text strong>简洁：</Text>直接明了，易于理解
                  </li>
                  <li>
                    <Text strong>创意：</Text>生动有趣，适合营销文案
                  </li>
                </ul>
              </div>
            </div>
